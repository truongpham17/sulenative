...
GET_CUSTOMER_SUCCESS,
 ...
 LOAD_DEBT_STORE_REQUEST,
 LOAD_DEBT_STORE_SUCCESS,
LOAD_DEBT_STORE_FAILURE,

ADD_CUSTOMER_DEBT_REQUEST,
ADD_CUSTOMER_DEBT_SUCCESS,
ADD_CUSTOMER_DEBT_FAILURE,
...
export default (state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case LOAD_DEBT_STORE_FAILURE:
      case LOAD_DEBT_STORE_SUCCESS:
    case ADD_CUSTOMER_DEBT_FAILURE:
    case ADD_CUSTOMER_DEBT_SUCCESS:
       return {
         ...state,
         loading: false
       };
      ...
      case LOAD_DEBT_STORE_REQUEST:
      case ADD_CUSTOMER_DEBT_REQUEST:
        return {
          ...state,
          loading: true
        };
